...
`git clone https://github.com/Jaggmort/star-burger.git`

Перейдите в папку проекта:
`cd star-burger`

Cоздайте файл `.env` со следующими настройками:
...
Измените файл /backend/nginx/default.conf, заменив ${NGINX_HOST} собственным доменом.

Установите Docker и Docker-compose
[Инструкция](https://www.howtogeek.com/devops/how-to-install-docker-and-docker-compose-on-linux/)

Запустите скрипт при первом деплое:
`./first_deploy.sh`

Сайт доступен для использования (если у вас настроен доступ с вашего дамена на сервер)

В дальнейшем для обновления проекта надо будет использовать следующий скрипт:
`./deploy.sh`
